...
pub struct Status {
    ...
    // @@protoc_insertion_point(field:clarifai.api.status.Status.developer_notes)
    pub developer_notes: ::std::string::String,
    // special fields
...
impl Status {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "developer_notes",
            |m: &Status| { &m.developer_notes },
            |m: &mut Status| { &mut m.developer_notes },
        ));
...
impl ::protobuf::Message for Status {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                82 => {
                    self.developer_notes = is.read_string()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.developer_notes.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.developer_notes);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.developer_notes.is_empty() {
            os.write_string(10, &self.developer_notes)?;
        }
    ...
    fn default_instance() -> &'static Status {
        static instance: Status = Status {
            ...
            developer_notes: ::std::string::String::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0credirectInfoB\x04\x80\x9c'\x01\x12'\n\x0fdeveloper_notes\x18\n\x20\
    \x01(\tR\x0edeveloperNotes\"\x95\x01\n\x0cRedirectInfo\x12\x10\n\x03url\
    \x18\x01\x20\x01(\tR\x03url\x12#\n\rresource_type\x18\x02\x20\x01(\tR\
    \x0cresourceType\x12&\n\x0fold_resource_id\x18\x03\x20\x01(\tR\roldResou\
    rceId\x12&\n\x0fnew_resource_id\x18\x04\x20\x01(\tR\rnewResourceId\"C\n\
    ...
    \x04\0\x02\0\x12\x03\x0e\x02\x16\x1a\"\x20Status\x20code\x20from\x20inte\
    rnal\x20codes.\n\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03\x0e\x02\x0c\n\x0c\n\
    \x05\x04\0\x02\0\x01\x12\x03\x0e\r\x11\n\x0c\n\x05\x04\0\x02\0\x03\x12\
    \x03\x0e\x14\x15\n0\n\x04\x04\0\x02\x01\x12\x03\x10\x02\x19\x1a#\x20A\
    \x20short\x20description\x20of\x20the\x20error.\n\n\x0c\n\x05\x04\0\x02\
    \x01\x05\x12\x03\x10\x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x10\t\
    \x14\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x10\x17\x18\n\xa0\x01\n\x04\
    \x04\0\x02\x02\x12\x03\x14\x02\x15\x1a\x92\x01\x20More\x20details\x20of\
    \x20the\x20given\x20error.\n\x20These\x20details\x20may\x20be\x20exposed\
    \x20to\x20non-technical\x20users.\n\x20For\x20technical\x20details,\x20t\
    ry\x20to\x20use\x20developer_notes\x20field.\n\n\x0c\n\x05\x04\0\x02\x02\
    \x05\x12\x03\x14\x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03\x14\t\x10\
    \n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x14\x13\x14\nZ\n\x04\x04\0\x02\
    \x03\x12\x03\x17\x02Q\x1aM\x20For\x20some\x20environment\x20we\x20may\
    \x20return\x20a\x20stack\x20trace\x20to\x20help\x20debug\n\x20any\x20iss\
    ues.\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03\x17\x02\n\n\x0c\n\x05\x04\0\
    \x02\x03\x05\x12\x03\x17\x0b\x11\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03\
    \x17\x12\x1d\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\x17\x20!\n\x0c\n\x05\
    \x04\0\x02\x03\x08\x12\x03\x17\"P\n\x0f\n\x08\x04\0\x02\x03\x08\xc0\xf3\
    \x04\x12\x03\x17#O\n1\n\x04\x04\0\x02\x04\x12\x03\x19\x02\x1f\x1a$\x20sp\
    ecifically\x20for\x20long\x20running\x20jobs\n\n\x0c\n\x05\x04\0\x02\x04\
    \x05\x12\x03\x19\x02\x08\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03\x19\t\x1a\
    \n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03\x19\x1d\x1e\nL\n\x04\x04\0\x02\
    \x05\x12\x03\x1b\x02\x1c\x1a?\x20if\x20status\x20is\x20pending,\x20how\
    \x20much\x20time\x20is\x20remaining\x20(in\x20seconds)\n\n\x0c\n\x05\x04\
    \0\x02\x05\x05\x12\x03\x1b\x02\x08\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03\
    \x1b\t\x17\n\x0c\n\x05\x04\0\x02\x05\x03\x12\x03\x1b\x1a\x1b\nT\n\x04\
    \x04\0\x02\x06\x12\x03\x1d\x02\x14\x1aG\x20A\x20request\x20ID\x20may\x20\
    be\x20present,\x20to\x20help\x20monitoring\x20and\x20tracking\x20request\
    s\n\n\x0c\n\x05\x04\0\x02\x06\x05\x12\x03\x1d\x02\x08\n\x0c\n\x05\x04\0\
    \x02\x06\x01\x12\x03\x1d\t\x0f\n\x0c\n\x05\x04\0\x02\x06\x03\x12\x03\x1d\
    \x12\x13\n^\n\x04\x04\0\x02\x07\x12\x03\x1f\x02M\x1aQ\x20Internal\x20Ann\
    otation\x20(do\x20not\x20set\x20in\x20production,\x20for\x20internal\x20\
    Clarifai\x20use\x20only).\n\n\x0c\n\x05\x04\0\x02\x07\x05\x12\x03\x1f\
    \x02\x08\n\x0c\n\x05\x04\0\x02\x07\x01\x12\x03\x1f\t\x19\n\x0c\n\x05\x04\
    \0\x02\x07\x03\x12\x03\x1f\x1c\x1d\n\x0c\n\x05\x04\0\x02\x07\x08\x12\x03\
    \x1f\x1eL\n\x0f\n\x08\x04\0\x02\x07\x08\xc0\xf3\x04\x12\x03\x1f\x1fK\n\\\
    \n\x04\x04\0\x02\x08\x12\x03!\x02P\x1aO\x20Resource\x20location\x20info\
    \x20for\x20redirect,\x20when\x20resource\x20location\x20has\x20been\x20c\
    hanged.\n\n\x0c\n\x05\x04\0\x02\x08\x06\x12\x03!\x02\x0e\n\x0c\n\x05\x04\
    \0\x02\x08\x01\x12\x03!\x0f\x1c\n\x0c\n\x05\x04\0\x02\x08\x03\x12\x03!\
    \x1f\x20\n\x0c\n\x05\x04\0\x02\x08\x08\x12\x03!!O\n\x0f\n\x08\x04\0\x02\
    \x08\x08\xc0\xf3\x04\x12\x03!\"N\n\xba\x01\n\x04\x04\0\x02\t\x12\x03%\
    \x02\x1e\x1a\xac\x01\x20Notes\x20for\x20developer.\n\x20These\x20notes\
    \x20are\x20rather\x20technical\x20details\x20for\x20developers\x20how\
    \x20to\x20interpret\x20the\x20status,\n\x20e.g.\x20why\x20an\x20error\
    \x20occurred\x20and\x20how\x20to\x20avoid\x20getting\x20the\x20error.\n\
    ...
    \x04\x04\x01\x02\0\x12\x03*\x02\x11\x1aF\x20New\x20location\x20for\x20th\
    e\x20resource.\x20Used\x20to\x20set\x20response\x20Location\x20header.\n\
    \n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03*\x02\x08\n\x0c\n\x05\x04\x01\x02\
    \0\x01\x12\x03*\t\x0c\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03*\x0f\x10\n\
    \x1c\n\x04\x04\x01\x02\x01\x12\x03,\x02\x1b\x1a\x0f\x20Resource\x20type\
    \n\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03,\x02\x08\n\x0c\n\x05\x04\x01\
    \x02\x01\x01\x12\x03,\t\x16\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03,\x19\
    \x1a\n\x1e\n\x04\x04\x01\x02\x02\x12\x03.\x02\x1d\x1a\x11\x20Old\x20reso\
    urce\x20id\n\n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03.\x02\x08\n\x0c\n\
    \x05\x04\x01\x02\x02\x01\x12\x03.\t\x18\n\x0c\n\x05\x04\x01\x02\x02\x03\
    \x12\x03.\x1b\x1c\n\x1e\n\x04\x04\x01\x02\x03\x12\x030\x02\x1d\x1a\x11\
    \x20New\x20resource\x20id\n\n\x0c\n\x05\x04\x01\x02\x03\x05\x12\x030\x02\
    \x08\n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x030\t\x18\n\x0c\n\x05\x04\x01\
    \x02\x03\x03\x12\x030\x1b\x1c\ni\n\x02\x04\x02\x12\x045\07\x01\x1a]\x20B\
    ase\x20message\x20to\x20return\x20when\x20there\x20is\x20a\x20internal\
    \x20server\x20error\x20that\n\x20is\x20not\x20caught\x20elsewhere.\n\n\n\
    \n\x03\x04\x02\x01\x12\x035\x08\x14\n\x0b\n\x04\x04\x02\x02\0\x12\x036\
    \x02\x14\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x036\x02\x08\n\x0c\n\x05\x04\
    \x02\x02\0\x01\x12\x036\t\x0f\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x036\x12\
    \x13b\x06proto3\
";
