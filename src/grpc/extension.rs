...
pub mod exts {
    ...
    pub const cl_private_field: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::FieldOptions, bool> = ::protobuf::ext::ExtFieldOptional::new(80320, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_BOOL);

    pub const cl_private_rpc: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::MethodOptions, bool> = ::protobuf::ext::ExtFieldOptional::new(80321, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_BOOL);

    pub const cl_depending_scopes: ::protobuf::ext::ExtFieldRepeated<::protobuf::descriptor::MethodOptions, ::protobuf::EnumOrUnknown<super::super::scope::S>> = ::protobuf::ext::ExtFieldRepeated::new(80322, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_ENUM);

    pub const cl_auth_type: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::MethodOptions, ::protobuf::EnumOrUnknown<super::super::types::AuthType>> = ::protobuf::ext::ExtFieldOptional::new(80323, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_ENUM);

    pub const cl_private_message: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::MessageOptions, bool> = ::protobuf::ext::ExtFieldOptional::new(80324, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_BOOL);
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10clPrivateMessageBe\n\x1bcom.clarifai.grpc.auth.utilP\x01Z=github.com\
    /Clarifai/clarifai-go-grpc/proto/clarifai/auth/util\xa2\x02\x04CAIPJ\xc0\
    \x11\n\x06\x12\x04\0\04\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\t\n\x02\
    \x03\0\x12\x03\x02\0/\n\t\n\x02\x03\x01\x12\x03\x03\0/\n\t\n\x02\x03\x02\
    \x12\x03\x05\0*\n\x08\n\x01\x02\x12\x03\x07\0\x1b\n\x08\n\x01\x08\x12\
    \x03\t\0T\n\t\n\x02\x08\x0b\x12\x03\t\0T\n\x08\n\x01\x08\x12\x03\n\0\"\n\
    \t\n\x02\x08\n\x12\x03\n\0\"\n\x08\n\x01\x08\x12\x03\x0b\04\n\t\n\x02\
    \x08\x01\x12\x03\x0b\04\n\x08\n\x01\x08\x12\x03\x0c\0\"\n\t\n\x02\x08$\
    \x12\x03\x0c\0\"\n\t\n\x01\x07\x12\x04\x0e\0\x12\x01\n\x85\x01\n\x02\x07\
    \0\x12\x03\x11\x02\x20\x1az\x20indicates\x20if\x20this\x20field\x20shoul\
    d\x20be\x20private.\x20If\x20true,\x20then\x20internal\x20use\x20only.\
    \x20If\x20False,\n\x20then\x20publicly\x20avaliable\x20to\x20world.\n\n\
    \n\n\x03\x07\0\x02\x12\x03\x0e\x07#\n\n\n\x03\x07\0\x05\x12\x03\x11\x02\
    \x06\n\n\n\x03\x07\0\x01\x12\x03\x11\x07\x17\n\n\n\x03\x07\0\x03\x12\x03\
    \x11\x1a\x1f\n\t\n\x01\x07\x12\x04\x14\0.\x01\n\x83\x01\n\x02\x07\x01\
    \x12\x03\x17\x02\x1e\x1ax\x20indicates\x20if\x20this\x20rpc\x20should\
    \x20be\x20private.\x20If\x20true,\x20then\x20internal\x20use\x20only.\
    \x20If\x20False,\n\x20then\x20publicly\x20available\x20to\x20world.\n\n\
    \n\n\x03\x07\x01\x02\x12\x03\x14\x07$\n\n\n\x03\x07\x01\x05\x12\x03\x17\
    \x02\x06\n\n\n\x03\x07\x01\x01\x12\x03\x17\x07\x15\n\n\n\x03\x07\x01\x03\
    \x12\x03\x17\x18\x1d\n\x97\n\n\x02\x07\x02\x12\x03*\x02=\x1a\x8b\n\x20Fo\
    r\x20each\x20grpc\x20method\x20we\x20define\x20a\x20list\x20of\x20requir\
    ed\x20low-level\x20auth\x20scopes\x20that\x20are\x20needed\n\x20for\x20t\
    he\x20key\x20that\x20is\x20issuing\x20the\x20request.\x20These\x20are\
    \x20checked\x20at\x20authorization\x20time\x20for\x20the\n\x20request\
