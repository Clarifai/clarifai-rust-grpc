...
const METHOD_V2_GET_DATASET_INPUTS_SEARCH_ADD_JOB: ::grpcio::Method<super::service::GetDatasetInputsSearchAddJobRequest, super::service::SingleDatasetInputsSearchAddJobResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/clarifai.api.V2/GetDatasetInputsSearchAddJob",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl V2Client {
    ...
    pub fn get_dataset_inputs_search_add_job_opt(&self, req: &super::service::GetDatasetInputsSearchAddJobRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::service::SingleDatasetInputsSearchAddJobResponse> {
        self.client.unary_call(&METHOD_V2_GET_DATASET_INPUTS_SEARCH_ADD_JOB, req, opt)
    }

    pub fn get_dataset_inputs_search_add_job(&self, req: &super::service::GetDatasetInputsSearchAddJobRequest) -> ::grpcio::Result<super::service::SingleDatasetInputsSearchAddJobResponse> {
        self.get_dataset_inputs_search_add_job_opt(req, ::grpcio::CallOption::default())
    }

    pub fn get_dataset_inputs_search_add_job_async_opt(&self, req: &super::service::GetDatasetInputsSearchAddJobRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::service::SingleDatasetInputsSearchAddJobResponse>> {
        self.client.unary_call_async(&METHOD_V2_GET_DATASET_INPUTS_SEARCH_ADD_JOB, req, opt)
    }

    pub fn get_dataset_inputs_search_add_job_async(&self, req: &super::service::GetDatasetInputsSearchAddJobRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::service::SingleDatasetInputsSearchAddJobResponse>> {
        self.get_dataset_inputs_search_add_job_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait V2 {
    ...
    fn get_dataset_inputs_search_add_job(&mut self, ctx: ::grpcio::RpcContext, _req: super::service::GetDatasetInputsSearchAddJobRequest, sink: ::grpcio::UnarySink<super::service::SingleDatasetInputsSearchAddJobResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
...
pub fn create_v2<S: V2 + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_V2_GET_DATASET_INPUTS_SEARCH_ADD_JOB, move |ctx, req, resp| {
        instance.get_dataset_inputs_search_add_job(ctx, req, resp)
    });
    let mut instance = s.clone();
